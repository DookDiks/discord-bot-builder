...
```ts
import { MemoryAdapter } from "@dookdiks/discord-bot-builder";
...
```ts
import { FileAdapter } from "@dookdiks/discord-bot-builder";
...
import { createAdapter } from "@dookdiks/discord-bot-builder";
...
```ts
import { DatabaseError } from "@dookdiks/discord-bot-builder";
