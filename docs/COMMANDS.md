...
```ts
import { CommandBuilder, PermissionFlagsBits } from "@dookdiks/discord-bot-builder";
...
```ts
import { CommandGroupBuilder } from "@dookdiks/discord-bot-builder";
...
```ts
import { UserContextMenuBuilder } from "@dookdiks/discord-bot-builder";
...
```ts
import { MessageContextMenuBuilder } from "@dookdiks/discord-bot-builder";
...
```ts
import { MessageCommandBuilder } from "@dookdiks/discord-bot-builder";
