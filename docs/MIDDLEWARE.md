...
```ts
import type { MiddlewareFn } from "discord-bot-builder";
...
```ts
import type { BotPlugin } from "discord-bot-builder";
...
```ts
import { EventBuilder } from "discord-bot-builder";
...
```ts
import { IntentBuilder } from "discord-bot-builder";
